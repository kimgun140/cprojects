...
int equip_sword(  Boki* boki){
    ...
    switch(depend_choice)
        {   // 이거를 하려면 어떻게 하냐 흠 프린트 문에서 i+1을 해서 1번으로 출력되게 하고 case 번호를 0번 시작이 아니라 1번 시작으로 하면된다.그리고 e
        //equip_choice scanf("%d",&equip_choice-1); 이렇게 -1을 넣어주면된다. equip함수에서 프린트문의 번호 바꿔주면된다.
            case 1 ://1티어 무기 장착하기
            int equip_choice;
...
int equip_mask( Boki* boki){
    ...
    boki->bokiEquipment.nomal.basicmask[1][1] = 5;// 마스크 첫번째 방어구 방어력 입력 개수, 방어력, 강화
    boki->bokiEquipment.nomal.basicmask[1][0] = 1;
    ...
    switch(depend_choice)
        {    
            ...
            printf("방어구번호를 입력하세요. \n");
            scanf("%d",&equip_choice-1); //5개중에 고르기 0~4번
...
int equip_armor(  Boki* boki){
    int depend_choice;
    //초기화
    boki->bokiEquipment.rare.halfarmor[0][1] = 5;// 마스크 첫번째 방어구 방어력 입력 개수, 방어력, 강화
    boki->bokiEquipment.rare.halfarmor[0][0] = 1;// 테스트 때문에 방어구 한개 넣어서 확인해보기
...
int equip_cape(  Boki* boki){
    int depend_choice;
    //초기화
    boki->bokiEquipment.epic.silkcape[0][1] = 5;// 마스크 첫번째 방어구 방어력 입력 개수, 방어력, 강화
    boki->bokiEquipment.epic.silkcape[0][0] = 1;// 테스트 때문에 방어구 한개 넣어서 확인해보기
...
int equip_gloves(  Boki* boki){
    int depend_choice;
    //초기화
    boki->bokiEquipment.legend.leardergloves[0][1] = 5;// 마스크 첫번째 방어구 방어력 입력 개수, 방어력, 강화
    boki->bokiEquipment.legend.leardergloves[0][0] = 1;// 테스트 때문에 방어구 한개 넣어서 확인해보기
    // 4티어 방어구 장착하기
    scanf("%d",&depend_choice);
    switch(depend_choice)
        { 
...
int equip_boots(  Boki* boki){// 부츠
    int depend_choice;
    //초기화
    boki->bokiEquipment.nomal.basicboots[0][1] = 5;// 마스크 첫번째 방어구 방어력 입력 개수, 방어력, 강화
    boki->bokiEquipment.nomal.basicboots[0][0] = 1;// 테스트 때문에 방어구 한개 넣어서 확인해보기
    printf("부츠 장착창입니다..\n");
...
int equip(Boki* boki){
    ...
    printf("갑바 장비창입니다.\n");
    printf("1번 기본갑바      2번 반팔갑바       3번 후드갑바        4번 용갑바     \n");
